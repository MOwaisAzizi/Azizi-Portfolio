...
import {BiLogoHtml5,BiLogoCss3, BiLogoAngular, BiLogoBootstrap, BiLogoJavascript, BiLogoNodejs, BiLogoReact, BiLogoTailwindCss,BiLogoJava,BiLogoMongodb } from 'react-icons/bi'
...
function TechStack() {
    ...
    return (
        <section className='mb-48 flex min-h[70vh] w-full flex-col items-center justify-center gap-16 md:gap-30' id='tech'>
            ...
            className='text-4xl text-white font-semibold md:text-5xl mt-5'>Skills</motion.h1>

            <div className='flex flex-wrap items-center justify-center gap-7 p-5 pt-0'>
