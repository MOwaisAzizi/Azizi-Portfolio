...
function TechStack() {
    ...
    return (
        <section className='mb-44 flex min-h[70vh] w-full flex-col items-center justify-center gap-16 md:gap-30 scroll-mt-20' id='techs'>
            ...
            <div className='flex flex-wrap items-center justify-center gap-5 md:gap-6 p-2 pt-0 sm:px-3'>
