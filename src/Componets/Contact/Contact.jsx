...
const Contact = () => {
  ...
  return (
    ...
    className="text-white mb-0 flex flex-col md:w-full items-center justify-center p-20 pt-14 pb-24 md:pt-16 scroll-mt-10 md:scroll-mt-16 " id="contact">
    <React.Fragment>
      <CssBaseline />
  ...
  backgroundRepeat: 'no-repeat',
          ...
          <div className="w-full max-w-md mx-2 md:mx-4" >
