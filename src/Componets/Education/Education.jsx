...
function Education() {
  ...
  return (
    <div
      className="text-white flex flex-col items-center justify-center mt-28 mb-28 px-7 sm:px-10 md:px-32 md:mt-32 scroll-mt-24 md:scroll-mt-28 "
      id="education"
    >
      <motion.h2
        variants={variants}
        ...
        className="text-center text-4xl font-semibold text-white md:text-5xl mb-20"
      >
        Eduaction
      </motion.h2>
